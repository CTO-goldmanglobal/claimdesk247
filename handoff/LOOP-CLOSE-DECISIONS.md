...
| **D-4** | **Scored 73-test regression** (G-62/G-51) | (a) Preview env + run green · (b) Accept live proof | CTO | ✅ **(a) run it** | **DONE 2026-06-14 — 75/75** vs deployed preview (fixed a UNIQUE-reference 500 found in the process). G-62/G-51 closed. ⚠️ delete the exposed Protection Bypass secret. **Update 2026-06-20: 79/79 (Stage 2 30 + Stage 3 31 + Stage 2.5 18; gained T-1-01..04 from G-PROD-LOCK/G-VER and T-25-017/T-25-018 MFA tests).** **Update 2026-06-21: 99/99** (Stage 2 30 + Stage 3 50 + Stage 2.5 19; further gained T-4-01..11 G-VER closure Tier-1 scenarios, T-6-* question injection, T-8-01/02 parked/not_listed, T-25-019 scenario-question). |
